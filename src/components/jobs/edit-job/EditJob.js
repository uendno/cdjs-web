...
import {requestJobDetails, saveBeingEditedJob, updateEditJobModalData} from '../../../actions/jobs';
import './EditJob.css';
import JobInfoComponent from './job-info/JobInfo';
import BuildConfigurationComponent from './build-configuration/BuildConfiguration';
...
class EditJobComponent extends Component {
  ...
  async componentDidMount() {
    ...
    updateEditJobFormData({loading: true});
      ...
      <div className="new-job-component">
        <div className="page-header">
          ...
          <div className="action-buttons">
            <Button
              className="button-with-icon action-button create-job-button"
              bsStyle="success"
...
const mapStateToProps = state => ({data: getModalDataForBeingEditedJob(state), credentials: getCredentials(state), jobName: getBeingEditedJobName(state)});
