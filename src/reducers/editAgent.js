import {
    ...
    ADD_AGENT_COMPLETE,
    ADD_AGENT_REQUEST,
    ADD_AGENT_ERROR, OPEN_EDIT_AGENT_MODEL, CLOSE_EDIT_AGENT_MODAL, UPDATE_EDIT_AGENT_MODAL_DATA, UPDATE_AGENT_COMPLETE,
    UPDATE_AGENT_REQUEST, UPDATE_AGENT_ERROR,
} from '../actions/types';
...
export const getDataForEditNameForm = (state) => {
    return {
        name: state.name,
        invalidNameMessage: state.modal.invalidNameMessage
    }
};